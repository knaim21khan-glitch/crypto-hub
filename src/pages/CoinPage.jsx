...
const CoinPage = () => {
  ...
  const [tradeModal, setTradeModal] = useState({ isOpen: false, coin: null, currentPrice: 0, mode: 'buy' });
  ...
  return (
    <div className="coinpage">
      <div className="sidebar">
        ...
        <PredictionPanel coin={coin} />
        <div className="coinpage_trade_buttons">
          <button
            className="coinpage_buy_btn"
